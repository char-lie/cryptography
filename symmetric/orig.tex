...
\usepackage[greek,russian,ukrainian]{babel}
\usepackage{amsmath}
...
\usepackage{hhline}
\usepackage{hyperref}
\hypersetup{pdftex, colorlinks=true, linkcolor=blue, citecolor=blue, filecolor=blue, urlcolor=blue, pdftitle=ЛЕКЦІЯ №1, pdfauthor=, pdfsubject=, pdfkeywords=}
...
\setlength\topmargin{0.9055in}
\setlength\oddsidemargin{0.9846in}
\setlength\textheight{8.955899in}
\setlength\textwidth{6.3071in}
\setlength\footskip{1.339in}
