...
\newcommand{\CDFOF}[2]{F_{#1}\left\{#2\right\}}
\newcommand{\CDF}[1]{\CDFOF{}{#1}}
\newcommand{\pdf}[1]{\mathrm{p}\left(#1\right)}
\def \entropy {H}
...
\def \Cryptosystem {\Sigma}
\def \MessagesSet {\mathcal{M}}
\def \CryptogramsSet {\mathcal{C}}
\def \KeysSet {\mathcal{K}}
\def \EAlgorithmsSet {\mathcal{E}}
\def \DAlgorithmsSet {\mathcal{D}}
